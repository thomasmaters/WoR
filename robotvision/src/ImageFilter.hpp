...
class ImageFilter
{
  ...
  private:
     ...
     * @author Thomas Maters
     */
    static cv::Mat applyBilateral(const cv::Mat& source);
    /**
     ...
     * @author Thomas Maters
     */
    static cv::Mat applyGaussianBlur(const cv::Mat& source);
    /**
     ...
     * @author Thomas Maters
     */
    static cv::Mat applyMedianBlur(const cv::Mat& source);
    /**
     ...
     * @author Thomas Maters
     */
    static cv::Mat applyEqualizeHist(const cv::Mat& source);
    /**
     ...
     * @author Thomas Maters
     */
    static cv::Mat applyEqualizeHistRGB(const cv::Mat& source);
    /**
     ...
     * @author Thomas Maters
     */
    static cv::Mat applyAdaptiveThreshold(const cv::Mat& source);
    /**
     ...
     * @author Thomas Maters
     */
    static cv::Mat applyPyreMeanShift(const cv::Mat& source);
    /**
