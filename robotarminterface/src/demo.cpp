...
int main(int argc, char **argv)
{
	...
	ros::Publisher definedServoPub = n.advertise<
			robotarminterface::moveServoDefinedMsg>("moveServoToDefinedPosition", 1000);
	ros::Publisher servoPosPub = n.advertise<
			robotarminterface::moveSingleServoMsg>("moveSingleServo", 1000);
	ros::Publisher emergencyStopPub = n.advertise<
			robotarminterface::emergencyStopMsg>("emergencyStop", 1000);
